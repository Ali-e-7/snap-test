        ...
        <div className="vendors">
            <div className="vendors__item">
                <div className="vendors__item__banner banner">
                        <img src={cardsData.backgroundImage} alt={cardsData.vendorTypeTitle}  />
                ...
                <div className="vendors__item__description">
                    <div className='description'>
                        <div className='description__name__discount'>
                            ...
                            {cardsData.discountValueForView > 0 ? <span className='discount'>تا {cardsData.discountValueForView}%</span> : null}
                        </div>
                        <div>5464646465</div>
                    </div>
                    <div className='food'>
